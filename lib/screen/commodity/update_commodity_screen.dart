...
class UpdateCommodityScreen extends StatefulWidget {
  const UpdateCommodityScreen(
      {super.key, required this.storeId, this.commodity});

  final String storeId;
  final DetailCommodity? commodity;

  @override
  State<UpdateCommodityScreen> createState() => _UpdateCommodityScreenState();
}

class _UpdateCommodityScreenState extends State<UpdateCommodityScreen> {
  ...
  void initState() {
    ...
    if (widget.commodity != null) {
      ...
      _stockController.text = widget.commodity!.stock.toString();

      if (widget.commodity!.category == 'Hairstyle') {
        selectedCategory = category[1];
      } else if (widget.commodity!.category == 'Haircare') {
        selectedCategory = category[0];
      } else {
        selectedCategory = widget.commodity!.category;
      }
    }
    super.initState();
  }
  ...
  Widget _buildImage() {
    ...
    final image = widget.commodity?.image;
